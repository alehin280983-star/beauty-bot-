...
HAIR_SERVICES = [
    ("Стрижка чоловіча", 30, 350),
    ("Стрижка бороди", 30, 250),
    ("Стрижка жіноча", 60, 550),
    ("Стрижка кінчиків", 30, 400),
    ("Стрижка дитяча (до 7 років)", 30, 300),
    ("Фарбування", 120, 850),
    ("Вкладання", 60, 500),
...
NAIL_SERVICES = [
    ...
    ("Манікюр", 30, 425),
    ("Педикюр повний", 60, 500),
    ("Педикюр частковий", 30, 300),
    ("Покриття гель-лак", 30, 350),
    ("Зняття гель-лаку + форма нігтів", 30, 200),
    ("Нарощування нігтів", 120, 1100),
    ("Корекція нарощенних нігтів", 120, 700),
]
